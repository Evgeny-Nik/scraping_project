...
REPO_NAME = os.getenv('REPO_NAME', "evgenys-scraping")
REPO_URL = os.getenv('REPO_URL',
                     "https://github.com/Evgeny-Nik/scraping_project_manifests/raw/master/docs/")
DAILY_CHART = os.getenv('DAILY_CHART', 'daily-job-0.1.0.tgz')
LIVE_CHART = os.getenv('LIVE_CHART', 'live-job-0.1.0.tgz')
